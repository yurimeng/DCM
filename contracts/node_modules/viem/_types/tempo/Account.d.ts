...
export type RootAccount = Account_base<'root'> & {
    ...
    signKeyAuthorization: (key: Pick<AccessKeyAccount, 'accessKeyAddress' | 'keyType'>, parameters: Pick<KeyAuthorization.KeyAuthorization, 'chainId' | 'expiry' | 'limits' | 'scopes'>) => Promise<KeyAuthorization.Signed>;
};
